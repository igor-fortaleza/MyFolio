...
const myCertificates_pt = [
	{
		date: "Jun 2022",
		title: "AZ-900 | Certified Microsoft Azure",
		description:
			"O AZ-900 é uma certificação que cobre os conceitos essenciais do Azure, oferecendo aos profissionais um entendimento aprofundado das capacidades e benefícios da plataforma de nuvem da Microsoft. Esta certificação é um passo importante para quem deseja se especializar no Azure, alinhando-se com a tendência crescente de adoção de cloud computing no mercado.",
		link: "https://www.credly.com/badges/62ea4067-eb56-45ff-bc2e-71d144ada45c",
	...
	{
		date: "Mar 2022",
		title: "OpenHack Microsoft: Containers & Kubernets (AKS)",
		description:
	...
	{
		date: "Dez 2021",
		title: "FIAP Certified Machine Learning Professional",
		description:
	...
	{
		date: "Dez 2021",
		title: "FIAP Certified Cognitive Services Specialist",
		description:
	...
	{
		date: "Dez 2022",
		title: "FIAP Certified Executive AI Manager",
		description:
	...
	{
		date: "Dez 2022",
		title: "FIAP Certified Computer Vision Expert",
		description:
			"O Certificado de Qualificação Profissional em Gestão de Inteligência Artificial qualifica profissionais para liderar e gerenciar projetos em inteligência artificial (IA). Este certificado atesta competências em supervisão técnica, gestão de recursos e implementação estratégica de soluções de IA em negócios. Ele prepara profissionais para coordenar equipes, liderar inovações tecnológicas e navegar pela transformação digital, destacando-os como líderes eficazes no campo da IA no ambiente corporativo.",
...
const myCertificates_en = [
	{
		date: "Jun 2022",
		title: "AZ-900 | Certified Microsoft Azure",
		description:
			"AZ-900 is a certification that covers the essential concepts of Azure, offering professionals a deep understanding of the capabilities and benefits of Microsoft's cloud platform. This certification is an important step for anyone looking to specialize in Azure, aligning with the growing trend of cloud computing adoption in the market.",
		link: "https://www.credly.com/badges/62ea4067-eb56-45ff-bc2e-71d144ada45c",
		logo: "./microsoft_logo.png",
		body: (
			<React.Fragment>
...
export default { myCertificates_pt, myCertificates_en };
